...
var Application = function () {
    function Application(spots, pages, data) {
        ...
        if (document.location.pathname === '/') {
            this.goToRandomSpot(function () {
                _this.enableHistorySupport();
            });
        } else {
    ...
    _createClass(Application, [{
        ...
        key: 'goToSpot',
        value: function goToSpot(slug, cb) {
            var _this2 = this;
            ...
            this.currentSpot.hide(function () {
                targetSpot.show(function () {
                    if (typeof cb === 'function') cb(_this2.currentLang, slug);
                });
        ...
        key: 'goToRandomSpot',
        value: function goToRandomSpot(cb) {
            var _this3 = this;

            var randomIndex = (0, _util.getRandomInt)(0, this.spots.length);
            var targetSpot = this.spots[randomIndex];

            this.goToSpot(targetSpot.el.dataset.slug || undefined, function () {
                if (typeof cb === 'function') cb(_this3.currentLang, targetSpot.el.dataset.slug);
            });
        }
    }, {
        key: 'updateHistory',
        ...
        value: function prevSpot() {
            ...
            this.goToSpot(slug || undefined, function () {
                _this4.updateHistory(_this4.currentLang, slug);
            });
        }
    }, {
        key: 'nextSpot',
        value: function nextSpot() {
            ...
            this.goToSpot(slug || undefined, function () {
                _this5.updateHistory(_this5.currentLang, slug);
            });
        }
    }, {
        key: 'initBindings',
        value: function initBindings() {
            ...
            (0, _util.each)(document.getElementsByClassName('lang__button'), function (node, i) {
                node.addEventListener('click', function (e) {
                    e.preventDefault();
                    _this6.translate(node.dataset.lang, function () {
                        _this6.updateHistory(node.dataset.lang, _this6.currentSpot.el.dataset.slug);
                    });
                });
            });
        }
        ...
        value: function enableHistorySupport() {
            ...
            history.replaceState({
                ...
                page: window.location.hash
            }, undefined, '/' + this.currentLang + '/spots/' + this.currentSpot.el.dataset.slug + '/');

            window.addEventListener('popstate', function (e) {
                if (e.state !== null) {
                    if (e.state.spot !== _this7.currentSpot.el.dataset.slug) {
                        _this7.goToSpot(e.state.spot);
                    }
                    if (e.state.lang !== _this7.currentLang) {
                        _this7.translate(e.state.lang);
                    }
                }
            });
        }
        ...
        key: 'translate',
        value: function translate(lang, cb) {
        ...
        value: function playVideo() {
            ...
            this.YouTubeIframeAPIReady.then(function () {
                ...
                _this8.player = new _player2.default(_this8.currentVideoId, 'player');
            });
        }
    }, {
        key: 'destroyVideo',
        ...
        get: function get() {
            ...
            return this.currentSpot.translations.find(function (translation) {
                return translation.lang === _this9.currentLang;
...
var Spot = function () {
    ...
    _createClass(Spot, [{
        ...
        value: function hide(cb) {
            ...
            var self = this;
            var transitionEvent = (0, _util.whichTransitionEvent)();
