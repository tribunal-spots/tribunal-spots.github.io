...
Object.defineProperty(exports, 'loadPolyfills', {
  enumerable: true,
  get: function get() {
...
var _swipe = __webpack_require__(12);

Object.defineProperty(exports, 'addSwipeEventDispatcher', {
  enumerable: true,
  get: function get() {
...
Object.defineProperty(exports, 'buildCollection', {
  enumerable: true,
  get: function get() {
    return _util.buildCollection;
  }
});
Object.defineProperty(exports, 'checkStatus', {
  enumerable: true,
  get: function get() {
    return _util.checkStatus;
  }
});
...
Object.defineProperty(exports, 'linkCollection', {
  enumerable: true,
  get: function get() {
    return _util.linkCollection;
  }
});
Object.defineProperty(exports, 'parseJSON', {
  enumerable: true,
  get: function get() {
    return _util.parseJSON;
  }
});
Object.defineProperty(exports, 'whichTransitionEvent', {
  enumerable: true,
  get: function get() {
    return _util.whichTransitionEvent;
  }
});
...
var _polyfills = __webpack_require__(10);

Object.defineProperty(exports, 'polyfills', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_polyfills).default;
  }
});
...
Object.defineProperty(exports, 'Spot', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_spot).default;
  }
});
...
var _he = __webpack_require__(15);
...
exports.default = [{
    ...
    load: function load() {
        return __webpack_require__.e/* import() */(2).then(__webpack_require__.bind(null, 23));
    }
}, {
    test: function test() {
...
exports.default = addSwipeEventDispatcher;
function addSwipeEventDispatcher(element) {
...
function buildCollection(Component, elements, data) {
    ...
    var _loop = function _loop(i) {
        ...
        var elData = data.find(function (item) {
            return item.slug === el.dataset.slug;
        });
...
var Application = function () {
    function Application(spots, pages, data) {
        ...
        this.spots = (0, _library.linkCollection)((0, _library.buildCollection)(_components.Spot, spots, data.spots));
        this.pages = (0, _library.buildCollection)(_components.Page, pages, data.pages);

        this.player = null;
        this.YouTubeIframeAPIReady = null;

        this.goToRandomSpotIfOnHomepage().then(function () {
            return _this.enableHistorySupport();
        });
    ...
    _createClass(Application, [{
        ...
        value: function fadeOut() {
            return new Promise(function (resolve, reject) {
                var transitionEvent = (0, _library.whichTransitionEvent)();
        ...
        value: function goToSpot(slug) {
            ...
            return new Promise(function (resolve, reject) {
                var targetSpot = slug ? _this2.findSpot(slug) : _this2.spots[0];

                _this2.fadeOut().then(function () {
                    _this2.currentSpot.hide();
                    targetSpot.show();

                    _this2.title = targetSpot.content.title;
        ...
        value: function goToRandomSpot() {
            ...
            return new Promise(function (resolve, reject) {
                var randomIndex = (0, _library.getRandomInt)(0, _this3.spots.length);
                var randomSpot = _this3.spots[randomIndex];

                _this3.goToSpot(randomSpot.el.dataset.slug).then(resolve);
            });
        }
    }, {
        key: 'prevSpot',
        value: function prevSpot() {
            ...
            var slug = this.currentSpot.prev.el.dataset.slug;

            this.goToSpot(slug).then(function () {
                return _this4.updateHistory(_this4.lang, slug);
            });
        }
    }, {
        key: 'nextSpot',
        value: function nextSpot() {
            ...
            var slug = this.currentSpot.next.el.dataset.slug;

            this.goToSpot(slug).then(function () {
                return _this5.updateHistory(_this5.lang, slug);
            });
        }
    }, {
        key: 'translate',
        ...
        key: 'updateHistory',
        value: function updateHistory(lang, spot) {
            var url = '/' + lang + '/spots/' + spot + '/' + window.location.hash;
        ...
        key: 'goToRandomSpotIfOnHomepage',
        value: function goToRandomSpotIfOnHomepage() {
            var _this6 = this;

            return new Promise(function (resolve, reject) {
                if (document.location.pathname === '/') {
                    _this6.goToRandomSpot().then(resolve);
                } else {
                    resolve();
                }
            });
        ...
        value: function enableHistorySupport() {
            ...
            var url = '/' + this.lang + '/spots/' + this.currentSpot.el.dataset.slug + '/';
            ...
            window.addEventListener('popstate', function (event) {
                if (event.state !== null) {
                    if (event.state.spot !== _this7.currentSpot.el.dataset.slug) {
                        _this7.goToSpot(event.state.spot);
                    }
                    if (event.state.lang !== _this7.lang) {
                        _this7.translate(event.state.lang);
                    }
                }
            });
        }
        ...
        value: function initBindings() {
            ...
            var spotsLayer = document.getElementById('layer__spots');

            // dispatch custom events 'swipeleft' and 'swiperight' on spotsLayer
            (0, _library.addSwipeEventDispatcher)(spotsLayer);

            spotsLayer.addEventListener('swiperight', function (event) {
                _this8.prevSpot();
            });

            spotsLayer.addEventListener('swipeleft', function (event) {
                _this8.nextSpot();
            });

            document.getElementById('spots__nav--prev').addEventListener('click', function (event) {
                event.preventDefault();
                _this8.prevSpot();
            });

            document.getElementById('spots__nav--next').addEventListener('click', function (event) {
                event.preventDefault();
                _this8.nextSpot();
            });

            document.getElementById('spots__play').addEventListener('click', function (event) {
                event.preventDefault();
                _this8.playVideo();
            });
            ...
            document.getElementById('video__close').addEventListener('click', function (event) {
                event.preventDefault();
                _this8.destroyVideo();
            });

            // TODO: check support for node.dataset
            (0, _library.each)(document.getElementsByClassName('lang__button'), function (node, i) {
                node.addEventListener('click', function (event) {
                    event.preventDefault();

                    _this8.translate(node.dataset.lang);
                    _this8.updateHistory(node.dataset.lang, _this8.currentSpot.el.dataset.slug);
                });
            });
        }
        ...
        value: function playVideo() {
            ...
            this.YouTubeIframeAPIReady.then(function () {
                ...
                _this9.player = new _components.Player(_this9.currentVideoId, 'player');
            });
        }
    }, {
        key: 'destroyVideo',
        ...
        get: function get() {
            ...
            return this.currentSpot.translations.find(function (translation) {
                return translation.lang === _this10.lang;
...
function init() {
    fetch('/data.json').then(_library.checkStatus).then(_library.parseJSON).then(function (data) {
        var spots = document.getElementsByClassName('spot');
        var pages = document.getElementsByClassName('page');
        var application = new _views.Application(spots, pages, data);
    }).catch(function (error) {
...
(0, _domready2.default)(function () {
    (0, _library.loadPolyfills)(_fixtures.polyfills).then(function () {
        return init();
    });
});
...
/***/ })
/******/ ]);
//# sourceMappingURL=data:application/json;charset=utf-8;base64,