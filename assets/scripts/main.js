...
var _spot = __webpack_require__(13);
...
var Application = function () {
    ...
    _createClass(Application, [{
        key: 'initSpots',
        value: function initSpots() {
            var _this = this;

            // 1. Add data to each slide with $.data

            _jquery2.default.each(this.$spots, function (index, el) {
                var $el = (0, _jquery2.default)(el);
                var el_data = _this.data.spots.find(function (spot) {
                    return spot.id === $el.data('id');
                });
                $el.data('spot', new _spot2.default($el, el_data));
        ...
        value: function initPages() {
            ...
            _jquery2.default.each(this.$pages, function (index) {
                var $this = (0, _jquery2.default)(_this2);
        ...
        value: function translate(lang) {
            ...
            this.$spots.each(function (index, el) {
                var $el = (0, _jquery2.default)(el);
...
var Spot = function () {
    ...
    _createClass(Spot, [{
        key: 'translate',
        value: function translate(lang) {
            var translated = this.data.translations.find(function (translation) {
                return translation.lang === lang;
            });
            this.$el.find('h2').text(translated.attributes.title);
            console.log(this.data.translations.find(function (item) {
...
(0, _jquery2.default)(function () {
    _jquery2.default.getJSON('/data.json', function (data) {
        var application = new _app2.default((0, _jquery2.default)('.slide'), (0, _jquery2.default)('.page'), data);
        application.talk();
        console.log(data);
