...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); // Polyfill Array.find
...
var _spot = __webpack_require__(14);
...
var Application = function () {
    ...
    _createClass(Application, [{
        ...
        value: function translate(lang) {
            ...
            document.querySelectorAll('.menu__primary a').forEach(function (el) {
                var currentPage = _this2.pages.find(function (page) {
                    return page.el.dataset.slug === el.dataset.slug;
                });
                var translation = currentPage.translations.find(function (translation) {
...
var _he = __webpack_require__(38);
...
var speciesConstructor = __webpack_require__(20);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(40)(module), __webpack_require__(39)))
